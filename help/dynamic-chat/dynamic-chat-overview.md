...
Bem-vindo ao site de tutoriais do [!UICONTROL Dynamic Chat]. Use estes tutoriais junto à documentação para melhorar sua compreensão de como usar o [!UICONTROL Dynamic Chat] para criar conversas personalizadas. Os seguintes tópicos podem ajudar você a começar:
...
* Configuração
   * **[Configurar e instalar seu chatbot](setup.md)**
     *Saiba mais sobre as etapas para configurar sua assinatura do [!UICONTROL Dynamic Chat].*
...
* Chat automatizado
   * **[Criar e gerenciar caixas de diálogo personalizadas](dialogue-management.md)**
     *Saiba como criar uma caixa de diálogo para engajar rapidamente seu visitante da Web com o [!UICONTROL Dynamic Chat].*
   * **[Inserir PDF em Conversas](document-cloud-integration.md)**
     *Compartilhar documentos do PDF em conversas personalizadas que você projeta no [!UICONTROL Dynamic Chat].*
   ...
   * **[Capturando atributos inferidos](capture-inferred-attributes.md)**
     *Podemos identificar e preencher atributos inferidos em relação a cada cliente potencial capturado pelo Dynamic Chat utilizando a Munchkin ID.*
   ...
   * **[Conversas SDK](conversations-sdk.md)**
     *Saiba como implementar o Conversations SDK para converter qualquer clique do CTA em uma conversa envolvente.*
   ...
   * **[Páginas de Aterrissagem de Conversação](conversational-landing-pages.md)**
     *Com apenas alguns cliques, instale os Fluxos de Conversação do Dynamic Chat em qualquer página de aterrissagem (Páginas de aterrissagem do Marketo ou Personalizadas) e converta qualquer link ou botão para acionar um envolvimento de conversação.*
