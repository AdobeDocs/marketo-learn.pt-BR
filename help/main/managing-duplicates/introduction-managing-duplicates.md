---
title: Introdução ao gerenciamento de duplicatas no Marketo Engage
description: Saiba mais sobre os conceitos principais de gerenciamento de registros duplicados no banco de dados do Marketo Engage, seu impacto nos fluxos de trabalho e quatro métodos para manter os dados limpos. Assista a cada clipe de vídeo para saber como manter seu banco de dados limpo e saudável.
role: Admin
...
# Introdução ao gerenciamento de duplicatas no Marketo Engage
